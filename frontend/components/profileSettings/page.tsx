    ...
    <div className="w-full h-screen flex flex-col justify-between text-white/90">
      <div className='flex flex-col'>
        ...
        <div className="flex my-4 flex-col gap-2 px-6 w-full">
          ...
          <div className="gap-3 flex-row justify-start items-center text-lg rounded-lg py-2 px-6 hover:bg-[#272729] transition ease-in duration-100 cursor-pointer hidden"
